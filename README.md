...
This can be solved by copying ``core.py`` from ``smoderp2d\bin\qgis\smoderp2d-plugin\grass_patch``
to GRASS target directory and overwrite existing file.

The GRASS target directory is typically located in:
