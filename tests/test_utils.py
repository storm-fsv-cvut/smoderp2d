...
class PerformTest:
    ...
    def run_dpre(self):
        ...
        # keep data file for roff test
        copyfile(dataprep_filepath, os.path.join(self._data_dir, 'gistest.save'))
    ...
    def run_roff(self, config_file):
        ...
        self._run()
        os.remove(os.path.join(self._data_dir, 'gistest.save')) # remove save file generated by run_dpre()
