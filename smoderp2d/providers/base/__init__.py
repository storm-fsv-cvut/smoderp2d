...
class BaseProvider(object):
    ...
    def _set_globals(self, data):
        ...
        # numpy.ma removal: a flat equivalent of masks that is added
        # alongside it and replaces nothing. valid[r, c] == True exactly
        # where masks[r][c] == False (a valid/unmasked cell).
