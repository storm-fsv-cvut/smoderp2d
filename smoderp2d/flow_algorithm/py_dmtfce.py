...
def removeCellsWithSameHeightNeighborhood(mat_elev, mat_nan, rows, cols):  # function determines if cell neighborhood has exactly same values of height a and than it save that cell as NoData
            ...
            for j in range(cols):
                if bc == 1:
                    ...
                    if bc_i == i and bc_j == j:
                        mat_elev[i][j] = -3.40282346639e+038
