...
Definition at line 136 of file Cumulative\-Max.\-py.
...
Definition at line 144 of file Cumulative\-Max.\-py.


\begin{DoxyCode}
144 
145   \textcolor{keyword}{def }\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_aa0e7706be42a1c06b1861c1e8c100c4c}{\_\_init\_\_}(self):
146 
147     prt.message(\textcolor{stringliteral}{'Save cumulative and maximum values from:'})
148     prt.message(\textcolor{stringliteral}{'\(\backslash\)tSurface'})
149 
150 
151     \textcolor{comment}{## Dictionary stores the python arrays identification.}
152     \textcolor{comment}{#}
153     \textcolor{comment}{#  self.arr is used in the smoderp2d.src.io\_functions.post\_proc}
154     \textcolor{comment}{#}
155     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a55debe509dff6cac1e187511891e8ca6}{arrs} = \{1  : \textcolor{stringliteral}{'infiltration'},
156             2  : \textcolor{stringliteral}{'precipitation'},
157             3  : \textcolor{stringliteral}{'h\_sur'},
158             4  : \textcolor{stringliteral}{'q\_sur'},
159             5  : \textcolor{stringliteral}{'V\_sur'},
160             6  : \textcolor{stringliteral}{'v\_sur'},
161             7  : \textcolor{stringliteral}{'shear\_sur'},
162             8  : \textcolor{stringliteral}{'h\_rill'},
163             9  : \textcolor{stringliteral}{'q\_rill'},
164             10 : \textcolor{stringliteral}{'V\_rill'},
165             11 : \textcolor{stringliteral}{'b\_rill'},
166             12 : \textcolor{stringliteral}{'inflow\_sur'},
167             13 : \textcolor{stringliteral}{'sur\_ret'},
168             14 : \textcolor{stringliteral}{'V\_sur\_r'},
169             15 : \textcolor{stringliteral}{'q\_sur\_tot'},
170             16 : \textcolor{stringliteral}{'V\_sur\_tot'}
171             \}
172 
173             \textcolor{comment}{#12 : 'v\_rill',}
174 
175 
176     \textcolor{comment}{## Dictionary stores the the arrays name used in the output rasters.}
177     \textcolor{comment}{#}
178     \textcolor{comment}{#  self.names is used in the smoderp2d.src.io\_functions.post\_proc}
179     \textcolor{comment}{#}
180     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a5c371c6f6e52bbd3ac4545f7bbe87bd3}{names} = \{1  : \textcolor{stringliteral}{'cinfil\_m'},
181             2  : \textcolor{stringliteral}{'crainf\_m'},
182             3  : \textcolor{stringliteral}{'cVInM3'},
183             4  : \textcolor{stringliteral}{'MaxQL3t\_1'},
184             5  : \textcolor{stringliteral}{'cSheetVOutM3'},
185             6  : \textcolor{stringliteral}{'mvel\_m\_s'},
186             7  : \textcolor{stringliteral}{'mshearstr\_pa'},
187             8  : \textcolor{stringliteral}{'MaxWaterRillL'},
188             9  : \textcolor{stringliteral}{'MaxQRillL3t\_1'},
189             10 : \textcolor{stringliteral}{'cRillVOutL3'},
190             11 : \textcolor{stringliteral}{'AreaRill'},
191             12 : \textcolor{stringliteral}{'CumVInL3'},
192             13 : \textcolor{stringliteral}{'SurRet'},
193             14 : \textcolor{stringliteral}{'CumVRestL3'},
194             15 : \textcolor{stringliteral}{'msurfl\_m3\_s'},
195             16 : \textcolor{stringliteral}{'csurvout\_m3\_s'}
196             \}
197             \textcolor{comment}{#12 : 'MaxVeloRill',}
198 
199 
200 
201     \textcolor{keywordflow}{if} (Globals.r == \textcolor{keywordtype}{None} \textcolor{keywordflow}{or} Globals.r == \textcolor{keywordtype}{None}):
202       sys.exit(\textcolor{stringliteral}{"Global variables are not assigned"})
203 
204     r = self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1General_1_1Globals_a69f9371306b49a71b87726b9142ea866}{r}
205     c = self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1General_1_1Globals_afe9be194e183190e467e005fd8817a64}{c}
206 
207 
208     \textcolor{comment}{## array count stored in the class}
209     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_ae4f8a2ce74c1284f06037cf0a28ec4c7}{n} = 13
210     \textcolor{comment}{## cumulative infiltrated volume [m3]}
211     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a2d35535475955e365c555506003ed956}{infiltration}  =  np.zeros([r,c],float)
212     \textcolor{comment}{## cumulative precipitation volume [m3]}
213     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_ab1532dc55bfb6a69559fbc6639c89de6}{precipitation} =  np.zeros([r,c],float)
214     \textcolor{comment}{## maximum surface water level [m]}
215     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a3f1bfdea16273c1d526adf267f151b8f}{h\_sur}  =  np.zeros([r,c],float)
216     \textcolor{comment}{## maximum surface discharge [m3s-1]}
217     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a638db7f8604658dc1e148a06019ae2b5}{q\_sur}  =  np.zeros([r,c],float)
218     \textcolor{comment}{## cumulative surface runoff volume [m3]}
219     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a5dba2fc38132916c8a27ba3181cc5abe}{V\_sur}  =  np.zeros([r,c],float)
220     \textcolor{comment}{## cumulative surface runoff volume [m3]}
221     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a6022a0431a925ed744c88ec683aec526}{V\_sur\_r}=  np.zeros([r,c],float)
222     \textcolor{comment}{## maximum surface velocity [ms-1]}
223     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_ae7d8b3364672d4cc58a69515441b65fe}{v\_sur}  =  np.zeros([r,c],float)
224     \textcolor{comment}{## maximum surface shear stress [Pa]}
225     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a5a77d63173ad36d599b00f21d0d2f109}{shear\_sur}  =  np.zeros([r,c],float)
226     \textcolor{comment}{## cumulative surface inflow volume [m3]}
227     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a6eac6988b76e8fb592a2fe73254a487f}{inflow\_sur}  =  np.zeros([r,c],float)
228     \textcolor{comment}{## maximum water level in rills [m]}
229     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a051fee65df3eaa945e2704cc9e1ec159}{h\_rill} =  np.zeros([r,c],float)
230     \textcolor{comment}{## maximum discharge in rills [m3s-1]}
231     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a74582962ffa39d74cafe5ba723ad38ea}{q\_rill} =  np.zeros([r,c],float)
232     \textcolor{comment}{## cumulative runoff volume in rills [m3]}
233     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_aa41ba52604c60795f131a41ebfa45025}{V\_rill}   =  np.zeros([r,c],float)
234     \textcolor{comment}{## cumulative runoff volume in rills [m3]}
235     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a3301f1f27bfd5ad1548b3c478759fe27}{V\_rill\_r} =  np.zeros([r,c],float)
236     \textcolor{comment}{## maximum rill width [m]}
237     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a16689860237806fdcb41b2e66f8961ec}{b\_rill} =  np.zeros([r,c],float)
238     \textcolor{comment}{## maximum velocity in rills [ms-1]}
239     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a362df44a6e225a24274bb136ffb07a90}{v\_rill} =  np.zeros([r,c],float)
240     \textcolor{comment}{## maximum surface retention [m]}
241     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_adff5e628465be89b7d4dcafe819c90c6}{sur\_ret}=  np.zeros([r,c],float)
242     \textcolor{comment}{## maximal total surface flow [m3/s]}
243     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a5fc3db54d59c21cd0b771f3778fede7c}{q\_sur\_tot}=  np.zeros([r,c],float)
244     \textcolor{comment}{## cumulative total surface flow [m3/s]}
245     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a79fde62f00a019dcad258bf8c819312e}{V\_sur\_tot}=  np.zeros([r,c],float)
246 
247 
248     super(Cumulative, self).\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_aa0e7706be42a1c06b1861c1e8c100c4c}{\_\_init\_\_}()
249 
250 
251 
...
Definition at line 256 of file Cumulative\-Max.\-py.


\begin{DoxyCode}
256 
257   \textcolor{keyword}{def }\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a8ff1f325481804578ec1cdc47616a808}{update\_cumulative}(self,i,j,surface,subsurface,delta\_t):
258 
259 
260     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a2d35535475955e365c555506003ed956}{infiltration}[i][j]  += surface.infiltration*self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1General_1_1Globals_a3d946a5e9e780d8da49b612367587d70}{pixel\_area}
261     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_ab1532dc55bfb6a69559fbc6639c89de6}{precipitation}[i][j] += surface.cur\_rain*self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1General_1_1Globals_a3d946a5e9e780d8da49b612367587d70}{pixel\_area}
262     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a5dba2fc38132916c8a27ba3181cc5abe}{V\_sur}[i][j]         += surface.V\_runoff
263     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a6022a0431a925ed744c88ec683aec526}{V\_sur\_r}[i][j]       += surface.V\_rest
264     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a79fde62f00a019dcad258bf8c819312e}{V\_sur\_tot}[i][j]       += surface.V\_rest + surface.V\_runoff
265     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a6eac6988b76e8fb592a2fe73254a487f}{inflow\_sur}[i][j]    += surface.inflow\_tm
266     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_adff5e628465be89b7d4dcafe819c90c6}{sur\_ret}[i][j]       += surface.cur\_sur\_ret*self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1General_1_1Globals_a3d946a5e9e780d8da49b612367587d70}{pixel\_area}
267 
268     q\_sheet = surface.V\_runoff/delta\_t
269     q\_rill  = surface.V\_runoff\_rill/delta\_t
270     q\_tot   = q\_sheet + q\_rill
271     \textcolor{keywordflow}{if} q\_tot > self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a5fc3db54d59c21cd0b771f3778fede7c}{q\_sur\_tot}[i][j] :
272       self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a5fc3db54d59c21cd0b771f3778fede7c}{q\_sur\_tot}[i][j] = q\_tot
273 
274     \textcolor{keywordflow}{if} surface.state == 0:
275       \textcolor{keywordflow}{if} surface.h\_total\_new > self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a3f1bfdea16273c1d526adf267f151b8f}{h\_sur}[i][j]:
276         self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a3f1bfdea16273c1d526adf267f151b8f}{h\_sur}[i][j] = surface.h\_total\_new
277         self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a638db7f8604658dc1e148a06019ae2b5}{q\_sur}[i][j] = q\_sheet
278 
279     \textcolor{keywordflow}{elif} (surface.state == 1) \textcolor{keywordflow}{or} (surface.state == 2):
280       self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_aa41ba52604c60795f131a41ebfa45025}{V\_rill}[i][j]   += surface.V\_runoff\_rill
281       self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a3301f1f27bfd5ad1548b3c478759fe27}{V\_rill\_r}[i][j] += surface.V\_rill\_rest
282       \textcolor{keywordflow}{if} surface.h\_total\_new > self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a3f1bfdea16273c1d526adf267f151b8f}{h\_sur}[i][j] :
283         self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a3f1bfdea16273c1d526adf267f151b8f}{h\_sur}[i][j] = surface.h\_total\_new
284         self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a638db7f8604658dc1e148a06019ae2b5}{q\_sur}[i][j] = q\_sheet
285 
286       \textcolor{keywordflow}{elif} surface.h\_rill > self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a051fee65df3eaa945e2704cc9e1ec159}{h\_rill}[i][j]:
287         self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a051fee65df3eaa945e2704cc9e1ec159}{h\_rill}[i][j]  = surface.h\_rill
288         self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a16689860237806fdcb41b2e66f8961ec}{b\_rill}[i][j]  = surface.b
289         self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a74582962ffa39d74cafe5ba723ad38ea}{q\_rill}[i][j]  = q\_rill
290 
291 
292     self.\hyperlink{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1CumulativeSubsurfacePass_a4cd34bafce5287c9f1ca7ebcf1f941a6}{update\_cumulative\_sur}(i,j,subsurface.arr[i][j],subsurface.q\_subsurface)
293 
294 
295 
296 
...
\hypertarget{classsmoderp2d_1_1src_1_1main__classes_1_1CumulativeMax_1_1Cumulative_a5c371c6f6e52bbd3ac4545f7bbe87bd3}{\index{smoderp2d\-::src\-::main\-\_\-classes\-::\-Cumulative\-Max\-::\-Cumulative@{smoderp2d\-::src\-::main\-\_\-classes\-::\-Cumulative\-Max\-::\-Cumulative}!names@{names}}
